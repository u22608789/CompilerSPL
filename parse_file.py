...
from spl.ast_printer import print_ast
from spl.ast_ids import assign_ids
from spl.scope_checker import ScopeChecker  # existing
from spl.codegen import CodeGenerator       # existing
from spl.type_checker import TypeChecker   # ✅ new
...
def main():
    ...
    # Default behavior: if no flags provided, print AST
    if not (args.check_scopes or args.dump_scopes or args.print_ast or args.type_check or args.codegen):
        args.print_ast = True
